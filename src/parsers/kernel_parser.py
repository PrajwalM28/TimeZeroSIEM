...
def parse_kernel_log(input_file, output_file):
    print("Starting the kernel log parsing...")  # Debugging print statement to confirm script execution
...
parse_kernel_log("data/raw_logs/kernel.log", "data/processed_logs/kernel_parsed.json")

...
def parse_authentication_log(input_file, output_file):
    print("Starting the log parsing...")  # Debugging print statement to confirm script execution
...
# Call the parsing function (you should adjust these file paths)
parse_authentication_log("data/raw_logs/authentication.log", "data/processed_logs/authentication_parsed.json")
